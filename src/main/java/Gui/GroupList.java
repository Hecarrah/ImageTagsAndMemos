 ...
 * @author Peter
 */
public class GroupList extends javax.swing.JInternalFrame {
        ...
        groupList.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    p.setGroupList(map.get(groupList.getSelectedValue()));
                    dispose();
                }
            }
        });
    ...
    public GroupList(MainWindow p, List<Card> list) {
        initComponents();
        parent = p;
        results(list);
        groupList.addKeyListener(new KeyAdapter() {
    ...
    private void initComponents() {
        ...
        searchButton.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_S, 0));
